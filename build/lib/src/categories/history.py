...
class History:
    ...
    def get_title(self):
        ...
        return self.get_response(
            f"Generate a title for a history book on {self.topic}. "
    ...
    def get_chapters(self, title: str):
        ...
        return self.get_response(
            f"Generate a list of the size {self.chapter_amount} of chapter titles for a history book called {title}. "
    ...
    def get_structure(self, title: str, chapters: list[str]):
        ...
        return self.get_response(
            f"Generate a structure plan for a history book called {title}. "
            ...
            f"\n\nFor each chapter, create a list of section titles and corresponding recommended word counts in the following format: "
            f"'section_title---word_amount.' The section titles should not include the word 'section' or a number. "
    ...
    def get_paragraph(self, title: str, chapters: list[str], paragraphs: list[list[dict[str, str]]],
        ...
        return self.get_response(
            f"Write the content for Chapter {chapter_index + 1} of a history book called {title}. The chapter is called {chapters[chapter_index]}, "
