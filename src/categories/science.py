...
class Science:
    ...
    def get_title(self):
        ...
        return self.get_response(f"Generate a title for a science book on {self.topic} in {self.language}. "
    ...
    def get_chapters(self, title: str):
        ...
        return self.get_response(
            f"Generate a list of the size {self.chapter_amount} of chapter titles for a science book on the topic {self.topic}, called {title} in {self.language}. "
    ...
    def get_structure(self, title: str, chapters: List[str]):
        ...
        return self.get_response(f"Generate a structure plan for a science book called {title} in {self.language}. "
    ...
    def get_paragraph(self, title: str, chapters: List[str], paragraphs: List[List[Dict[str, str]]],
        ...
        return self.get_response(
            f"Write the content for Chapter {chapter_index + 1} in {self.language} of a science book called {title}. The chapter is called {chapters[chapter_index]}, "
